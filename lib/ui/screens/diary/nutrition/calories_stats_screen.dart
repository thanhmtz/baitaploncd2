                                      ...
                                      itemBuilder: ((context, index) {
                                        return ListTile(
                                          title: Text(breakfast['foods'][index]
                                                  ['name']
                                              .toString()),
                                          subtitle: Text(breakfast['foods'][index]
                                                  ['calories']
                                              .toString()),
                                        );
                                      })),
                                  NutritionRow(
                                      protein: _toDouble(breakfast['breakfastProtein']),
                                      carbs: _toDouble(breakfast['breakfastCarbs']),
                                      fat: _toDouble(breakfast['breakfastFat']))
                                ]),
                              ),
                            ),
                            const SizedBox(height: 24),
                            Card(
                              ...
                              child: Padding(
                                ...
                                child: Column(children: [
                                  ...
                                  NutritionRow(
                                      protein: _toDouble(lunch['lunchProtein']),
                                      carbs: _toDouble(lunch['lunchCarbs']),
                                      fat: _toDouble(lunch['lunchFat']))
                                ]),
                              ),
                            ),
                            const SizedBox(height: 24),
                            Card(
                              ...
                              child: Padding(
                                ...
                                child: Column(children: [
                                  ...
                                  NutritionRow(
                                      protein: _toDouble(dinner['dinnerProtein']),
                                      carbs: _toDouble(dinner['dinnerCarbs']),
                                      fat: _toDouble(dinner['dinnerFat']))
                                ]),
                              ),
                            ),
                            const SizedBox(height: 24),
                            Card(
                              ...
                              child: Padding(
                                ...
                                child: Column(children: [
                                  ...
                                  NutritionRow(
                                      protein: _toDouble(snacks['snacksProtein']),
                                      carbs: _toDouble(snacks['snacksCarbs']),
                                      fat: _toDouble(snacks['snacksFat']))
                                ]),
                              ),
                            ),
                            const SizedBox(height: 24),
